...
function main() {
  ...
  if (savedCookie) {
    ...
    replaceHeaderOnly(WYYHeaders, "x-music-u", injectedMusicU);
    ...
    write(
      ...
      JSON.stringify({
        ...
        final_x_music_u: WYYHeaders["x-music-u"] || WYYHeaders["X-Music-U"],
...
function replaceHeaderOnly(headers, name, value) {
  if (!value) return;
  var keyName = name;
